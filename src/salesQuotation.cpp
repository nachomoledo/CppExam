...
{
    std::string str;
    str.append("Número de identificación: " + m_id);
    str.append("\n");
    str.append("Fecha y Hora de la cotización: " + m_date + " " + m_time);
    str.append("\n");
    str.append("Código del vendedor: " + m_sellerId);
    str.append("\n");
    str.append("Prenda cotizada: " + m_garment);
    str.append("\n");
    /* FIXME: formatear número */
